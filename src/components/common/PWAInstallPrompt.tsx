...
export default function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 z-50 animate-slide-up">
