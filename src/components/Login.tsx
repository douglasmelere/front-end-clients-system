...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!passwordValidation.isValid) {
      toast.showError(`Senha inválida: ${passwordValidation.errors[0]}`);
      return;
    }
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 hover:shadow-3xl transition-all duration-500">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-r from-[#35cc20] to-[#6edc5f] rounded-3xl mb-6 shadow-[0_4px_14px_0_rgba(53,204,32,0.25)] hover:shadow-[0_0_20px_rgba(0,255,136,0.4)] hover:scale-110 transition-transform duration-300 group">
              <PagluzLogo className="h-20 w-20 text-white group-hover:scale-110 transition-transform duration-500" width={80} height={80} />
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            <div className="space-y-3">
              <div className="flex items-center text-sm text-slate-600 hover:text-green-600 transition-colors duration-200 group">
                <div className="flex items-center justify-center w-6 h-6 bg-[#35cc20]/20 rounded-full mr-3 group-hover:bg-[#35cc20]/30 transition-colors duration-200">
                  <PagluzLogo className="h-3 w-3 text-[#35cc20] group-hover:scale-110 transition-transform duration-500" width={12} height={12} />
                </div>
