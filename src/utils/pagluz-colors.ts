...
export const pagluzColors = {
  ...
  // Gradientes
  gradients: {
    primary: 'from-pagluz-blue-800 via-pagluz-blue-700 to-pagluz-green-600',
    secondary: 'from-pagluz-green-500 to-pagluz-green-600',
    accent: 'from-pagluz-blue-50 to-pagluz-green-50',
  }
};
